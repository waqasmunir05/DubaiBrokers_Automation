@rejectExtendContract @database
Feature: Contract A - Reject Contract Extension
...
@rejectExtension
Scenario: Create, Approve, Extend Contract and Reject Extension Approval
  ...
  And I click on Search button to find contract
  And I click on searched contract result
  And I click on "Extend" button
  And I add "2" years to contract period
  And I click on "Save" button
  Then I should see success message "Contract has been extended successfully"
  When I land on the dashboard
  And I click on "Contracts" tab
  And I close the popup message
  And I enter the created contract number
