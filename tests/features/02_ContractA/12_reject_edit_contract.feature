@rejectEditContract @database
Feature: Contract A - Reject Edited Contract
...
@rejectEditedContract
Scenario: Create, Approve, Edit Contract and Reject Edit Approval
  ...
  And I update sell price to "1250000"
  And I click on "Save" button
  Then I should see success message "Contract has been updated successfully"
  When I land on the dashboard
  And I click on "Contracts" tab
  And I close the popup message
  And I enter the created contract number
